...
//   // When fixedMode is set the Send/Request toggle is hidden and the screen
//   // operates in a single mode. SendMoneyScreen and RequestMoneyScreen use this
//   // so the user reaches a single-purpose screen from the More menu.
...
//     // Warn before discarding partially filled form data when the user switches modes.
...
//   // Branches on mode: send moves money immediately; receive only creates a request record.
...
//   return (
//     //gesture handler root view for the whole screen and it is for the animation to work
