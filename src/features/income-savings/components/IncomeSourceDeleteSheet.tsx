...
import { getIncomeNeutralIconColor, INCOME_WHITE_ICON } from "../constants";
import { styles } from "../stylesheet";

type IncomeSourceDeleteSheetProps = {
...
export function IncomeSourceDeleteSheet({
  modalRef,
  snapPoints,
  bottomInset,
  isDark,
    ...
    >
      <BottomSheetView style={styles.sheetContent}>
        ...
        <View style={styles.sheetActions}>
          ...
          >
            <View style={styles.sheetBtnRow}>
              <MaterialIcons
                name="close"
                size={16}
                color={getIncomeNeutralIconColor(isDark)}
              />
          ...
          >
            <View style={styles.sheetBtnRow}>
              <MaterialIcons name="delete-forever" size={16} color={INCOME_WHITE_ICON} />
